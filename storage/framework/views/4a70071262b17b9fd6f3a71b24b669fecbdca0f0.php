...
<div class="row py-5 align-items-center">
  <div class="col-lg-6 col-sm-12 photo-profile-2">
    <img style="width: 80px" class="rounded-circle float-start mb-4" src="<?php echo e(asset('images/photo-profile.jpg')); ?>" alt="Photo Profile" />
  </div>
  ...
  <div class="col-lg-6 col-sm-12">
    <img style="width: 176px" class="rounded-circle float-end photo-profile-1" src="<?php echo e(asset('images/photo-profile.jpg')); ?>" alt="Photo Profile" />
  </div>
</div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\laravel\hafizhpratama.dev\resources\views/welcome.blade.php ENDPATH**/ ?>